...
def run_fier(AOI_str, doi, in_run_type):
    ...
    #hist_real_stack_path = qm_scaling_path+'hist_obs_full.nc'
    #hist_syn_stack_path = qm_scaling_path+'hist_syn_full.nc'
    ...
    #hist_syn_wf=xr.load_dataarray(hist_syn_stack_path)
    ...
    st_time=time.time()
    #map_fct_syn_wf = perf_qm(fct_syn_wf, qm_scaling_path, qm_pr_r_mask)
